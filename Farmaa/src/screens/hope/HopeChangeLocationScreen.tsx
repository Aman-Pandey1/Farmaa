...
const HopeChangeLocationScreen = () => {
  ...
  const selectLocation = (loc: LocationItem) => {
    navigation.navigate('Hope' as never, { selectedLocation: loc.title } as never);
  };
  ...
  return (
    ...
    >
      ...
      <TouchableOpacity style={styles.currentLocBtn} onPress={() => selectLocation(suggestions[0])}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.locRow} onPress={() => selectLocation(item)}>
